...
simu.startTime = TIME_START;            % Simulation Start Time [s]
simu.rampTime = 100;                    % Wave Ramp Time [s]
simu.endTime = TIME_END;                % Simulation End Time [s]
simu.solver = 'ode4';                   % simu.solver = 'ode4' for fixed step & simu.solver = 'ode45' for variable step 
simu.dt = DT; 							% Simulation time-step [s]
...
waves.height = WAVES_HEIGHT;            % Wave Height [m]
waves.period = WAVES_PERIOD;            % Wave Period [s]
...
pto(1).stiffness = PTO_STIFFNESS;               % PTO Stiffness [N/m]
pto(1).damping = PTO_DAMPING;                   % PTO Damping [N/(m/s)]
